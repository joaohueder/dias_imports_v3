...
export default function PainelConfiguracoesWhatsappPage() {
  ...
  if (loading && !data) {
    return (
      <div className="min-h-screen bg-[#070b14] flex flex-col items-center justify-center text-slate-400 gap-4">
        ...
        <span className="text-sm font-medium">Carregando WhatsApp & Conexão...</span>
      </div>
    );
  }
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="flex items-center gap-2.5">
                <h1 className="text-xl font-black text-white tracking-tight">WhatsApp & Conexão</h1>
              ...
              <p className="text-xs text-slate-400 mt-0.5 font-medium">
                Conecte seu WhatsApp via QRCode, monitore métricas de envio e teste disparos em tempo real.
              </p>
            </div>
          </div>
        </div>
